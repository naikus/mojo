...
(function(window, $, undefined) {
  ...
  (function($, undefined) {
    $.extension("navigation", function() {
      ...
      nav.on(Events.tap, function(e, li, model) {
  ...
  $.ready(function() {
    ...
    App.Navigation = $("#navContainer").navigation();
    ...
    var actTemplate = $.template('<span class="icon {icon}"></span> {title}'),
        actionBarContainer = $("#globalActionBar"),
    ...
    App.getActionBarAction = function(id) {
